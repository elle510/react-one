...
/***/ function(module, exports, __webpack_require__) {
	...
	var LiveObject = React.createClass({
		...
		render: function render() {
			return React.createElement(
				Pum.Splitter,
				{ sizeLeft: 200, minLeft: 100, maxLeft: 350, minHeight: 300 },
				React.createElement(
					Pum.SplitterPane,
					null,
					React.createElement(
				...
				React.createElement(
					Pum.SplitterPane,
					{ type: 'v', sizeRight: 700, minRight: 300, maxRigit: 1000 },
					React.createElement(
						Pum.SplitterPane,
						null,
						'조회 대상 영역'
	...
	ReactDom.render(React.createElement(LiveObject, null), document.getElementById('app'));

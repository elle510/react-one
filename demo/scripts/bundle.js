...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDom.render(React.createElement(ReactPum.JqGrid, { options: options }), document.getElementById('jqgrid'));
	ReactDom.render(React.createElement(ReactPum.Test, null), document.getElementById('test'));
